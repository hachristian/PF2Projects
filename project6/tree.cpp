...
//-----------------------------------------------------------
bool BinaryTree::InsertHelper(string Name, unsigned long Count, double Percentage, int Rank, Node *&Tree)
{
...
//-----------------------------------------------------------
bool BinaryTree::Insert(string Name, unsigned long Count, double Percentage, int Rank)
{
